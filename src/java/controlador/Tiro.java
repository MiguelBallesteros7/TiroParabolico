...
public class Tiro extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       int velocidad;
        if (request.getParameter("velocidad") != null) {
        ...
        modelo.tiro tiroP = new modelo.tiro(velocidad,angulo);
        ArrayList<String> angulos = Utilidades.getAngulos();
        double alcance=tiroP.getAlcanceMax();
        double altura=tiroP.getAlturaMax();
        request.setAttribute("tiroP", tiroP);
        request.setAttribute("angulos", angulos);
